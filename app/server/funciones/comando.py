            ...
            if longitud_trama==1:
                ...
                if notificacion['imei']=="866782048942516":
                    ...
                    ", ambient_air= %s ,relative_humidity= %s ,avl = %s , defrost_prueba = %s , ripener_prueba = %s , ethylene = %s"
                        " , set_point_co2 = %s , co2_reading = %s , humidity_set_point = %s , sp_ethyleno = %s , compress_coil_1 = %s ,power_state = %s WHERE estado = 1 AND telemetria_id = %s  ")
                    curB.execute(update_old_salary, (trama['fecha'], objetoV['set_point'],objetoV['temp_supply_1'], 
                                                        ...
                                                        objetoV['power_state'],objetoV['telemetria_id']  ))
                    cnx.commit()
